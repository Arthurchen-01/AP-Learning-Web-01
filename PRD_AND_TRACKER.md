...
- [ ] **P1.1 - v2顶部导航栏重构**：当前v2只有顶部bar，无完整学科导航。当前 `/v2/` 首页只有stats和subjects grid，需补充导航栏（首页/套题模考/专项训练/Dashboard/Profile）

- [ ] **P1.2 - MCQ即时反馈机制**：当前选中选项后仅高亮，但不做对错判断和解析展示。需要：答对绿色闪烁+"Correct!"提示，答错红色shake+"Incorrect"提示+正确答案高亮+解析文本展示
